...
@section('breadcrumbs')
    ...
    <li>@lang('admin_static_pages.static_pages')</li>
@stop
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
            <h1 class="page-title txt-color-blueDark"><i class="fa fa-calendar fa-fw "></i>
                @lang('admin_static_pages.static_pages')
            </h1>
        </div>
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8 text-right pull-right">
            <a href="{{url(config('app.admin_route').'/static-pages/create')}}" class="btn btn-lg btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> @lang('admin_general.add_new')</a>
        </div>
    </div>
                ...
                <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>@lang('admin_general.filters_slug')</label>
                                                    <input class="form-control" type="text" name="slug" value="{{ Illuminate\Support\Facades\Input::get('slug') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>@lang('admin_general.filters_is_draft')</label>
                                                    <select name="is_draft" class="select2" style="width: 100%">
                                                        <option value=""></option>
                    ...
                    <div data-widget-editbutton="false" data-widget-deletebutton="false" class="jarviswidget jarviswidget-color-darken">
                        ...
                        <header>
                            ...
                            <h2>@lang('admin_static_pages.static_pages')</h2>
                        </header>
                                ...
                                @if(count($results))
                                    <table class="table table-striped table-bordered table-listing table-hover smart-form ">
                                        ...
                                        <tr>
                                            ...
                                            <th><a class="{{ $listing->sortDir("slug") }}" href="{{ $listing->sortLink("slug") }}"><span>@lang('admin_general.listing_slug')</span></a></th>
                                            ...
                                            <th style="width: 100px"><a class="{{ $listing->sortDir("is_draft") }}" href="{{ $listing->sortLink("is_draft") }}"><span>@lang('admin_general.listing_is_draft')</span></a></th>
                                        ...
                                        @foreach($results_arr as $r)
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <a href="{{url(config('app.admin_route').'/static-pages/'.$r->id)}}/edit" class="btn btn-sm btn-info apply-tooltip" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>&nbsp;&nbsp;
                                                    @if(empty ($r->code_page ))
                                                        <a href="javascript:deleteRouteObject('{{url(config('app.admin_route').'/static-pages/'.$r->id)}}')" class="btn btn-sm btn-danger btn-delete apply-tooltip" data-method="DELETE" title="Delete" data-warning="Are you sure?"><i class="glyphicon glyphicon-trash"></i></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
