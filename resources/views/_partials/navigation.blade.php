<nav id="main_navigation">
    ...
    <div class="nav-inner">
        ...
        <ul class="navigation-links">
            ...
            @endif
            <li><a href="https://twitter.com/_redtutorial" target="_blank" rel="noopener" class="twitter-account" ><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://www.youtube.com/channel/UCdiASKn5toBvQZV_TJKCM8A" target="_blank" rel="noopener" class="twitter-account" ><i class="fab fa-youtube"></i></a></li>
        </ul>
    </div>
