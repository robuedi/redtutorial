<nav id="main_navigation">
    ...
    <div class="nav-inner">
        ...
        <ul class="navigation-links">
            ...
            <li class="display-inline-block" ><a href="https://www.youtube.com/channel/UCdiASKn5toBvQZV_TJKCM8A" target="_blank" rel="noopener" ><i class="fab fa-youtube"></i></a></li>
            <li class="display-inline-block" ><a href="https://www.facebook.com/com.RedTutorial" target="_blank" rel="noopener" ><i class="fab fa-facebook-square"></i></a></li>
        </ul>
    </div>
